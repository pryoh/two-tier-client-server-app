...
public class SQLClientApplication extends JFrame {
    ...
    *********************************/
    ...
    public SQLClientApplication() {
        ...
        *********************************/
        ...
        String[] PropertiesItems1 = {"bikedb.properties", "project3.properties"};
        String[] PropertiesItems2 = {"root.properties", "client1.properties", "client2.properties"};
        ...
        //Set up the frame
        setTitle("SQL Client Application - (RCM - CNT4714 - Spring 2024 - Project 3)");
        setSize(1024, 768);
                ...
                try {
                    ...
                    try {
                        ...
                        if(userCredentialsOK) {
                            ...
                            connectionInfoLabel.setText("NOT CONNECTED - User Credentials Do Not Match Properties");
                        }
                    } //end try
            ...
            public void actionPerformed(ActionEvent event) {
                try {
                    if (connection != null) {
                        ...
                        if (queryArea.getText().trim().toLowerCase().startsWith("select")) {
                            // It's a SELECT query
                            tableModel.setQuery(queryArea.getText());
                            resultTable.setModel(tableModel);
                        } else {
                            // It's an INSERT, UPDATE, DELETE operation
                            int affectedRows = tableModel.setUpdate(queryArea.getText());
                            JOptionPane.showMessageDialog(null, affectedRows + " rows affected.", "Update Successful", JOptionPane.INFORMATION_MESSAGE);
                        }
                    } else {
